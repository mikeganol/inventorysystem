...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Add New Member</h5>
                    <p class="text-center small">Fill the File to be a Member!</p>
                  </div>
  ...
  $gender = $row['gender'];
                  ...
                  ?>
                          ...
                          <form method="POST" action="customer_process_update.php">
                    ...
                    <div class="col-12">
                      ...
                      value ="<?php echo  $customer_lastname; ?>" placeholder="Enter Last Name">
                      <div class="invalid-feedback">Please, enter your Lastname name!</div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      value ="<?php echo $customer_firstname; ?>" placeholder="Enter first Name">
                      <div class="invalid-feedback">Please, enter your First name!</div>
                    </div>

                    <div class="col-12">
                      <label for="customer_middlename" class="form-label">Middle Name</label>
                      <input type="text" name="customer_middlename" class="form-control" id="customer_middlename" 
                      value ="<?php echo $customer_middlename; ?>" placeholder="Enter Middle Name">
