...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-people"></i><span>Items</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
  ...
  <main id="main" class="main">
    ...
    <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Add New item</h5>
                    <p class="text-center small">Fill the File to be a itemr!</p>
                  </div>
  ...
  $item_condition = $row['item_condition'];
                  ...
                  ?>
                          ...
                          <form method="POST" action="items_process_update.php">
                    ...
                    <div class="col-12">
                      ...
                      value ="<?php echo  $item_name; ?>" placeholder="Enter item Name">
                    ...
                    <div class="col-12">
                      ...
                      value ="<?php echo $item_type; ?>" placeholder="Enter item type">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="item_condition" class="form-control" id="item_condition"
                      value ="<?php echo $item_condition; ?>" placeholder="item_condition">
