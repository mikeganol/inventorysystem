...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-people"></i><span>Custodian</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="users_list.php">
              <i class="bi bi-circle"></i><span>Custodian List</span>
            </a>
          </li>
          <li>
            <a href="add_users.php">
              <i class="bi bi-circle"></i><span>Add New Custodian</span>
            </a>
          </li>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add New Custodian</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item">Custodian</li>
          <li class="breadcrumb-item active">Add New Custodian</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Add New custodian</h5>
                    <p class="text-center small">Fill the File to be a Custodian!</p>
                  </div>
  ...
  $custodian_lastname = $row['custodian_lastame'];
  $custodian_firstname = $row['custodian_firstname'];
  ...
  $gender = $row['gender'];
                  ...
                  ?>
                          ...
                          <form method="POST" action="custodian_process_update.php">

                    <input type="hidden" name="custodian_id" value="<?php echo $custodian_id; ?>">

                    <div class="col-12">
                      <label for="custodian_lastname" class="form-label">Last Name</label>
                      <input type="text" name="custodian_lastname" class="form-control" id="custodian_lastname" 
                      value ="<?php echo  $custodian_lastname; ?>" placeholder="Enter Last Name">
                      <div class="invalid-feedback">Please, enter your Last name!</div>
                    </div>

                    <div class="col-12">
                      <label for="custodian_firstname" class="form-label"> First Name</label>
                      <input type="text" name="custodian_firstname" class="form-control" id="custodian_firstname"
                      value ="<?php echo $custodian_firstname; ?>" placeholder="Enter first Name">
                      <div class="invalid-feedback">Please, enter your First name!</div>
                    </div>

                    <div class="col-12">
                      <label for="custodian_middlename" class="form-label">Middle Name</label>
                      <input type="text" name="custodian_middlename" class="form-control" id="custodian_middlename" 
                      value ="<?php echo $custodian_middlename; ?>" placeholder="Enter Middle Name">
                    ...
                    <div class="col-12">
                      ...
                      value ="<?php echo $gender; ?>" placeholder="gender">
