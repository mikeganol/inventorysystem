...
<body>
    ...
    <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Fill the File to be a iuser!</p>
                  </div>
  ...
  $user_type = $row['user_type'];
                  ...
                  ?>
                          ...
                          <form method="POST" action="users_process_update.php">
                    ...
                    <div class="col-12">
                      ...
                      value ="<?php echo $user_type; ?>" placeholder="Enter user_type">
                      <div class="invalid-feedback">Please, enter your user type!</div>
                    </div>
